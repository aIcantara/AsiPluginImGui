...
void CRenderer::PushRenderState( const D3DRENDERSTATETYPE dwState, DWORD dwValue )
{
    DWORD dwTempValue;
...
void CRenderer::DrawString( int16_t x, int16_t y, color_t color, CFont* font, bool outlined, bool centered, const char* text, ... )
{
    va_list args;
    char buf[ 256 ];
    va_start( args, text );
...
void CRenderer::DrawLine( int16_t x1, int16_t y1, int16_t x2, int16_t y2, color_t color )
{
    Vertex_t pVertex[ 2 ];
...
void CRenderer::DrawFilledBox( int16_t x, int16_t y, int16_t width, int16_t height, color_t color )
{
    Vertex_t pVertex[ 4 ];
...
void CRenderer::DrawBox( int16_t x, int16_t y, int16_t width, int16_t height, int16_t thickness, color_t color )
{
...
void CRenderer::DrawBox( int16_t x, int16_t y, int16_t width, int16_t height, color_t color )
{
    Vertex_t pVertex[ 5 ];
...
void CRenderer::DrawGradientBox( int16_t x, int16_t y, int16_t width, int16_t height, color_t color1, color_t color2, color_t color3, color_t color4 )
{
    Vertex_t pVertex[ 4 ];
...
void CRenderer::DrawCircle( int16_t x, int16_t y, int16_t radius, uint16_t points, RenderDrawType flags, color_t color1, color_t color2 )
{
...
void CRenderer::DrawCircleSector( int16_t x, int16_t y, int16_t radius, uint16_t points, uint16_t angle1, uint16_t angle2, color_t color1, color_t color2 )
{
    angle1 += 270;
    angle2 += 270;
...
void CRenderer::DrawRing( int16_t x, int16_t y, int16_t radius1, int16_t radius2, uint16_t points, RenderDrawType flags, color_t color1, color_t color2 )
{
...
void CRenderer::DrawRingSector( int16_t x, int16_t y, int16_t radius1, int16_t radius2, uint16_t points, uint16_t angle1, uint16_t angle2, color_t color1, color_t color2 )
{
    angle1 += 270;
    angle2 += 270;
...
void CRenderer::DrawTriangle( int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3, RenderDrawType flags, color_t color1, color_t color2, color_t color3 )
{
    if ( !( flags & RenderDrawType_Gradient ) )
    {
        color2 = color1;
...
void CRenderer::DrawQuad( int16_t x1, int16_t y1,
...
CRenderer::CRenderer( IDirect3DDevice9* device, bool bUseDynamicSinCos ) :
